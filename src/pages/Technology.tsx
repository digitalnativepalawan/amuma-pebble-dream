...
import { ArrowLeft, Link as LinkIcon, Cpu, ShieldCheck, Gem, Palmtree } from "lucide-react";
...
const Section = ({
  ...
  return (
    <section id={id} className="section-padding bg-background">
      <div ref={ref} className="scroll-reveal container px-6">
        {children}
      </div>
    </section>
  );
      ...
      <TableHeader>
        <TableRow className="border-border">
          {headers.map((h) => (
            <TableHead
              key={h}
              className="font-body text-xs uppercase tracking-[0.15em] text-muted-foreground"
            >
              {h}
            </TableHead>
          ))}
            ...
            {row.map((cell, j) => (
              <TableCell
                ...
                className={`font-body text-sm leading-relaxed ${
                  j === 0 ? "text-foreground font-medium" : "text-foreground/70"
                }`}
              >
                {cell}
              </TableCell>
...
const CodeBlock = ({ children }: { children: string }) => (
  <pre className="font-mono text-xs sm:text-sm leading-relaxed text-foreground/70 bg-muted/40 p-6 overflow-x-auto rounded-sm border border-border">
    {children}
  </pre>
);
...
const Technology = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ──────────────────── SECTION 1: OVERVIEW ──────────────────── */}
      <Section id="overview">
        <p className="font-body text-xs uppercase tracking-[0.15em] text-muted-foreground mb-4">
          Investment Technology
        </p>
        <h1 className="font-display text-3xl sm:text-5xl font-bold text-primary uppercase tracking-[0.08em] mb-8 leading-tight max-w-2xl">
        ...
        <p className="font-body text-base text-foreground/70 leading-relaxed max-w-xl mb-10">
          The Palawan Hidden Gems Project combines physical real estate
          development with blockchain technology. Every property — from{" "}
          <span className="text-foreground font-medium">
            Amuha Long Beach (2,000 sqm, 9 keys)
          </span>{" "}
          to future developments in{" "}
          <span className="text-foreground font-medium">
            Balabac, Port Barton, and El Nido
          </span>{" "}
          — is represented as digital{" "}
          <span className="text-primary font-medium">PEBBLES</span> on an
          immutable ledger.
        </p>
      ...
      <Section id="ledger">
        ...
        <p className="font-body text-base text-muted-foreground mb-12">
          The permanent record of ownership.
        </p>

        <SubHeading>What It Is</SubHeading>
        <p className="font-body text-base text-foreground/70 leading-relaxed mb-12 max-w-xl">
          A blockchain ledger is a decentralised digital database that records
          all ownership and transaction data across a network of computers.
          Unlike traditional databases controlled by a single entity, blockchain
          creates a shared source of truth that cannot be altered retroactively.
        </p>
        ...
        <ComparisonTable
          ...
          rows={[
            [
              "Ownership Record",
              "Paper deeds, local registry",
              "Digital Pebbles on immutable ledger",
            ],
            [
              "Transaction History",
              "Difficult to trace",
            ...
            [
              ...
              "Weeks of paperwork",
              "Instant Pebble transfer",
            ],
            [
              "Transparency",
              "Limited visibility",
              "All verified investors see verified history",
            ],
          ]}
        />
      ...
      <Section id="smart-contracts">
        ...
        <p className="font-body text-base text-foreground/70 leading-relaxed mb-12 max-w-xl">
          Smart contracts are self-executing agreements written in code that live
          on the blockchain. When predetermined conditions are met, they
          automatically execute specified actions — no intermediaries required.
        </p>

        {/* A. Creation */}
        <p className="font-body text-xs uppercase tracking-[0.15em] text-muted-foreground mb-4">
          A. Pebble Creation &amp; Distribution
        </p>
        <p className="font-body text-sm text-foreground/70 mb-4">
          When you invest in Phase 1a (2026):
        </p>
...
THEN
  ...
  AND record ownership on blockchain permanently`}</CodeBlock>
        ...
        {/* B. Rental */}
        <p className="font-body text-xs uppercase tracking-[0.15em] text-muted-foreground mb-4">
          B. Rental Income Distribution
        </p>
        <p className="font-body text-sm text-foreground/70 mb-4">
          For Amuha Long Beach's 9 keys (Villa ₱18,000 · Suite ₱12,000 · 5 Deluxe ₱5,500):
        </p>
        ...
        <p className="font-body text-sm text-foreground/70 mb-4">
          Pebble holders vote on major decisions — 1 Pebble = 1 vote:
        </p>
        ...
        <p className="font-body text-sm text-muted-foreground max-w-lg">
          The smart contract tallies votes, enforces majority decisions, and records outcomes permanently.
        </p>
      ...
      <Section id="whitelist">
        ...
        <p className="font-body text-base text-muted-foreground mb-12">
          Curated investor gateway.
        </p>

        <SubHeading>What It Is</SubHeading>
        <p className="font-body text-base text-foreground/70 leading-relaxed mb-12 max-w-xl">
          A whitelist is a curated list of approved wallet addresses that have
          permission to interact with our investment smart contracts. Only
          whitelisted addresses can purchase Pebbles, receive distributions, or
          vote on governance.
        </p>
          ...
          {[
            {
              ...
              desc: "Submit government ID, proof of address, and accredited investor verification (if applicable).",
            },
            {
              step: "02",
              title: "Wallet Address Submission",
              desc: "Provide your blockchain wallet address (MetaMask, Trust Wallet, etc.).",
            },
            {
              step: "03",
              title: "Smart Contract Addition",
              desc: "Your address is added to the whitelist contract with permissions to purchase Pebbles, receive distributions, vote, and access the investor dashboard.",
            },
            {
              step: "04",
              title: "Confirmation",
              desc: "You receive verification and can immediately participate.",
            },
          ].map((s) => (
            <div key={s.step} className="flex gap-6">
              <span className="font-display text-4xl font-normal text-primary leading-none">
                {s.step}
              </span>
              <div>
        ...
        <ComparisonTable
          ...
          rows={[
            [
              "Kickstarter Tier",
              "Early commitment",
              "Priority pricing, first access to Phase 1a, reduced fees",
            ],
            [
              "Founders Tier",
              "Higher commitment",
              "All above + governance super-voting (1 Pebble = 2 votes), exclusive updates",
            ],
            [
              "Institutional Tier",
              "Major commitment",
              "All above + direct board observation rights",
            ],
          ]}
        />
      </Section>
      ...
      <Section id="why-pebbles">
        <h2 className="font-display text-3xl sm:text-4xl font-bold text-primary uppercase tracking-[0.1em] mb-4">
          Why Pebbles for Palawan Real Estate?
        </h2>
        <p className="font-body text-base text-muted-foreground mb-12">
        ...
        <ComparisonTable
          ...
          rows={[
            [
              "Title complexity",
              "Pebbles represent beneficial ownership through compliant legal structure",
            ],
            [
              "Foreign investment restrictions",
              "Structured under Philippine law with blockchain as record layer",
            ],
            [
              "Transparency",
              "Every Pebble transaction visible to verified investors",
            ],
            [
              "Liquidity",
              "Pebbles can be traded on compliant secondary markets",
            ],
          ]}
        />
      </Section>
        ...
        <ComparisonTable
          ...
          rows={[
            [
              "2026",
              "Phase 1a Begins",
              "Pebble generation event, whitelist opens, first smart contracts deployed",
            ],
            [
              "2027",
              "Phase 1b Launches",
              "Rental distribution active, governance voting begins",
            ],
            [
              "2028–2030",
              "Expansion",
              "New property Pebbles issued to existing holders first",
            ],
            [
              "2031+",
              "Secondary Market",
              "Pebbles tradable on compliant exchanges",
            ],
          ]}
        />
      </Section>
      ...
      <Section id="tech-faq">
        ...
        <div className="max-w-lg">
          <Accordion type="single" collapsible>
            {[
              {
                q: "Why do you call them Pebbles?",
                a: "Just as pebbles on a beach are small pieces of something beautiful and enduring, our Pebbles represent small, valuable pieces of Palawan's most stunning properties — fractional ownership that's accessible, transparent, and built to last.",
              },
              {
                q: "Do I need to be a blockchain expert to invest?",
                a: "No. Our team handles all technical aspects. You simply complete KYC, get whitelisted, and receive Pebbles. The dashboard shows everything in simple terms.",
              },
              {
                q: "What if I lose access to my wallet?",
                a: "Multi-signature recovery options are built into the smart contracts, with legal fallbacks.",
              },
              {
                q: "Can I see my rental income in pesos?",
                a: "Yes. The dashboard converts all Pebble activity to PHP (or your preferred currency).",
              },
              {
                q: "How are taxes handled on distributions?",
                a: "You receive detailed reports of all distributions; you're responsible for your own tax compliance.",
              },
              {
                q: "Are Pebbles considered securities?",
                a: "Yes, Pebbles are structured as security tokens compliant with Philippine regulations.",
              },
              {
                q: "What's the minimum investment?",
                a: "Varies by tier, starting at approximately ₱500,000 for Kickstarter tier.",
              },
            ].map((faq, i) => (
              <AccordionItem
                key={i}
      ...
      <div className="container px-6 py-12">
        <p className="font-body text-xs text-muted-foreground leading-relaxed max-w-xl">
          This information is for qualified investors only. Pebbles represent
          fractional ownership in specific properties and involve risk, including
          possible loss of principal. Blockchain technology involves technical
          risks. Consult with advisors before investing.
        </p>
      </div>
