...
const blockTypes = [
  ...
  { type: "list", label: "List", icon: List, defaultContent: { heading: "", items: [""], footnote: "" } },
  ...
  { type: "timeline", label: "Timeline", icon: Clock, defaultContent: { heading: "", entries: [{ year: "", title: "", detail: "" }] } },
  { type: "faq", label: "FAQ", icon: HelpCircle, defaultContent: { heading: "", faqs: [{ q: "", a: "" }] } },
  { type: "columns", label: "Columns", icon: Columns, defaultContent: { heading: "", columns: [{ heading: "", items: [] }, { heading: "", items: [] }] } },
